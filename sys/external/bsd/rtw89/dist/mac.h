...
/*
 * Lab (RK3568): upstream Linux spells the WOW CPU-IO-RX handshake retry count
 * here (mac.c rtw89_mac_cpu_io_rx()); the v7.0 snapshot ported from predates
 * the retry loop, and without it the ~6 ms firmware acknowledgement does not
 * fit RTW89_C2H_TIMEOUT_USB.  See the comment in mac.c.
 */
